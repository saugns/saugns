 ...
 */
static uint32_t hash_string(SGSSymTab_t o, const char *str, uint32_t len) {
	uint32_t i;
	uint32_t hash;
	/*
	 * Calculate hash.
 ...
 */
static int32_t extend_strtab(SGSSymTab_t o) {
 ...
 */
const char *SGS_symtab_pool_str(SGSSymTab_t o, const char *str, uint32_t len) {
	uint32_t hash;
	StringEntry *entry;
 ...
 */
const char *SGS_symtab_lookup_str(SGSSymTab_t o, int id) {
	StringEntry *entry;
