...
/**
 * True if at call position, prior to calling callback. (The callback
 * is expected to change the call position.)
 */
#define SGS_CBufMode_NEEDCB(o) \
	((o)->pos == (o)->call_pos)

/**
 * Call callback if needed.
 */
#define SGS_CBufMode_HANDLECB(o) ((void) \
	(SGS_CBufMode_NEEDCB(o) && (o)->callback(o)))
 ...
 * it has been decreased (wrapping around) as in e.g. character
 * ungetting. If length between calls is smaller than the buffer
 * size, a length longer than that between calls may then be
 * returned.
 */
...
#define SGS_CBufMode_FIXP(o) ((void) \
	(SGS_CBufMode_NEEDCB(o) || ((o)->pos &= SGS_CBUF_SIZ - 1)))
...
typedef struct SGS_CBuf SGS_CBuf;

void SGS_init_CBuf(SGS_CBuf *o);
 ...
 * times equal to (SGS_CBUF_ALEN - 1) plus the number of characters gotten
...
/**
 * Undo the getting of \p n number of characters. This can safely be done
 * for n <= (SGS_CBUF_ALEN - 1) plus the number of characters gotten within
