 ...
 */
static inline SGSAudioDev *open_sndio(const char *name,
 ...
 */
static inline void close_sndio(SGSAudioDev *o) {
 ...
 */
static inline bool sndio_write(SGSAudioDev *o, const int16_t *buf,
		uint32_t samples) {
