...
enum {
	...
	SAU_SCAN_WS_RED1,    // reduce ws chars of same type to one SAU_SCAN_*
	SAU_SCAN_WS_RED2,    // reduce ws character sequence to one SAU_SCAN_*
...
uint8_t SAU_Scanner_filter_space_join(SAU_Scanner *restrict o, uint8_t c);
