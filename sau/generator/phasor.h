 ...
 */
static sauMaybeUnused void
sauPhasor_pdist_pulwm_mul(sauPhasor *restrict o sauMaybeUnused,
		float *restrict phase_f,
		uint32_t *restrict cycle_ui32,
		size_t len,
		const float *restrict v_f,
 ...
 */
static sauMaybeUnused void
sauPhasor_pdist_pulwm_div(sauPhasor *restrict o sauMaybeUnused,
		float *restrict phase_f,
		uint32_t *restrict cycle_ui32,
		size_t len,
		const float *restrict v_f,
 ...
 */
static sauMaybeUnused void
sauPhasor_pdist_hold(sauPhasor *restrict o sauMaybeUnused,
		float *restrict phase_f,
		uint32_t *restrict cycle_ui32,
		size_t len,
		const float *restrict v_f,
 ...
 */
static sauMaybeUnused void
sauPhasor_pdist_halfx(sauPhasor *restrict o sauMaybeUnused,
		float *restrict phase_f,
		uint32_t *restrict cycle_ui32,
		size_t len,
		const float *restrict v_f,
 ...
 */
static sauMaybeUnused void
sauPhasor_pdist_halfy(sauPhasor *restrict o sauMaybeUnused,
		float *restrict phase_f,
		uint32_t *restrict cycle_ui32,
		size_t len,
		const float *restrict v_f,
