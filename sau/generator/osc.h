/* SAU library: Oscillator implementation.
...
#if USE_PILUT
	uint32_t old_offset = SAU_Wave_picoeffs[o->wave].phase_adj;
	uint32_t offset = SAU_Wave_picoeffs[wave].phase_adj;
...
static void SAU_Osc_reset(SAU_Osc *restrict o, uint32_t phase) {
