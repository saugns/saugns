...
/* Sound operator modulators, all types. */
enum {
	MGS_MOD_NONE = 0,
	MGS_MOD_AM,
	MGS_MOD_FM,
...
typedef struct MGS_ProgramSndopData MGS_ProgramSndopData;
