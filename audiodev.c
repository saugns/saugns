 ...
 * written any number of times using SGSAudioDev_write().
 *
 ...
 */
uint32_t SGSAudioDev_get_srate(const SGSAudioDev *o) {
	return o->srate;
}
 ...
 */
bool SGSAudioDev_write(SGSAudioDev *o, const int16_t *buf, uint32_t samples) {
#ifdef __linux
