...
static void postparse_passes(SGS_ParseEventData *e_list);
...
SGS_ParseResult *SGS_Parser_process(SGS_Parser *o, const char *fname) {
	if (!SGS_File_openfrb(&o->file, fname)) {
