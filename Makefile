...
builder/parseconv.o: builder/parseconv.c program.h wave.h math.h builder/script.h builder/ptrlist.h common.h
	$(CC) -c $(CFLAGS) builder/parseconv.c -o builder/parseconv.o

builder/parser.o: builder/parser.c builder/script.h builder/ptrlist.h builder/symtab.h program.h wave.h math.h common.h
