...
parser.o: common.h math.h mgensys.h parser.c program.h symtab.h
...
generator.o: common.h generator.c math.h mgensys.h program.h osc.h
	$(CC) -c $(CFLAGS) generator.c

osc.o: common.h math.h mgensys.h osc.c osc.h
	$(CC) -c $(CFLAGS) osc.c
