...
builder/builder.o: arrtype.h builder/builder.c builder/builder.h common.h math.h mempool.h nodelist.h program.h ptrlist.h ramp.h saugns.h script.h wave.h
	$(CC) -c $(CFLAGS) builder/builder.c -o builder/builder.o

builder/scriptconv.o: arrtype.h builder/builder.h builder/scriptconv.c common.h math.h mempool.h nodelist.h program.h ptrlist.h ramp.h script.h wave.h
	$(CC) -c $(CFLAGS) builder/scriptconv.c -o builder/scriptconv.o

builder/voicegraph.o: arrtype.h builder/builder.h builder/voicegraph.c common.h math.h mempool.h nodelist.h program.h ramp.h script.h wave.h
