...
builder.o: builder.c sgensys.h builder/lexer.h builder/script.h program.h builder/ptrlist.h wave.h math.h common.h
...
builder/parseconv.o: builder/parseconv.c program.h wave.h math.h builder/script.h builder/ptrlist.h arrtype.h common.h
	$(CC) -c $(CFLAGS) builder/parseconv.c -o builder/parseconv.o

builder/parser.o: builder/parser.c builder/script.h builder/ptrlist.h builder/symtab.h builder/file.h program.h wave.h math.h common.h
