...
parser.o: math.h mgensys.h parser.c program.h symtab.h
	$(CC) -c $(CFLAGS) parser.c

symtab.o: mgensys.h symtab.c symtab.h
	$(CC) -c $(CFLAGS) symtab.c

generator.o: generator.c math.h mgensys.h program.h osc.h
	$(CC) -c $(CFLAGS) generator.c

osc.o: math.h mgensys.h osc.c osc.h
	$(CC) -c $(CFLAGS) osc.c
